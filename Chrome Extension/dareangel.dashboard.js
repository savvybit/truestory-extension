                ...
                browser.tabs.sendMessage(tabs[0].id, { command: "requestArticles" }, (response) => {
                    if (response !== undefined) {
                        ...
                        this._articlesList.forEach((element) => {
                            ...
                            var images = newImageHTMLElement.getElementsByTagName('img'); 
...
window.onload = function (e) {
    ...
    var x1 = document.getElementsByClassName('backgroundContainerTS')[0];
    var x2 = document.getElementsByClassName('headerContainerTS')[0];

    x1.setAttribute("style", "height: " + x2.offsetHeight + "px;");

    document.getElementById('imagesCollection').offsetWidth = document.getElementsByClassName('bg1').offsetWidth;
